...
**2026-05-09 store ctx threading + decomposition (CA-183 + CA-182)** — 11 commits, `71f6542` + `150c094` + `8a3ccd0` + `eefa122` + `fa084b4` + `2eaad0d` + `1244396` + `037bf2d` + `0105f3d` + `7081107` + `c67be11`.
