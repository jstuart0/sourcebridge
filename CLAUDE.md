...
**2026-05-09 store ctx threading + decomposition (CA-183 + CA-182)** — 7 commits, `71f6542` + `150c094` + `8a3ccd0` + `eefa122` + `fa084b4` + `b7e6193` + `1244396`.
