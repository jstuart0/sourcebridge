...
export const metadata: Metadata = {
  ...
  description:
    "A codebase cliff notes and context layer for unfamiliar systems: explain code, review changes, see change impact, and connect specs to implementation when you need it.",
};
