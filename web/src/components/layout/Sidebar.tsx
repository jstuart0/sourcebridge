  ...
  return (
    <>
      ...
      <aside
        ...
        className={cn(
          "hidden min-h-screen flex-col border-r border-[var(--border-subtle)] bg-[var(--nav-bg)]/95 px-3 py-4 shadow-[var(--panel-shadow-soft)] transition-[width] duration-200 md:flex",
